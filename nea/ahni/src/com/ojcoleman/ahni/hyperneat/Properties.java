 ...
 */
public class Properties extends nea.ahni.src.com.anji.util.Properties {
	 ...
	 */
	public Properties(nea.ahni.src.com.anji.util.Properties values) {
		super(values);
	}
	...
	public Object newObjectProperty(String key) {
		try {
			...
			else if (result instanceof nea.ahni.src.com.anji.util.Configurable) {
				((nea.ahni.src.com.anji.util.Configurable) result).init(this);
			}
			return result;
