...
//		Organism deadorg;// = new Vector<Organism>();
...
//			curspecies++;
//
//			if(curspecies != sorted_species.lastElement()){ //if (curspecies!=sorted_species.end()) {
//
...
//					++curspecies;
//				}
//				while(curspecies != sorted_species.lastElement()){
//					curspecies.expected_offspring = 0;
//					curspecies++;
//				}
//			}
...
//				//	++curspecies;
//				
//				while(curspecies != sorted_species.lastElement() && curspecies.last_improved() > Neat.dropoff_age){
//					curspecies++;
//				}
//
...
//				}
//				
//				if(stolen_babies >= one_fifth_stolen && curspecies != sorted_species.lastElement()){
...
//					}
//				}
//				if(curspecies != sorted_species.lastElement()){
//					if(stolen_babies >= one_fifth_stolen){
//						curspecies.organisms.get(0).super_champ_offspring = one_fifth_stolen;
//						curspecies.expected_offspring += one_fifth_stolen;
//						stolen_babies -= one_fifth_stolen;
...
//		//  (*curspecies)->reproduce(generation,this,sorted_species);
//		
//		while(curspecies != species.lastElement()){
//			curspecies.reproduce(generation, this, sorted_species);
//
...
//		  }
//		  
//		  while(curspecies2 != species.lastElement()){
//			  if(curspecies2.id == last_id)
//				  curspecies = curspecies2;
//			  curspecies2++;
//		  }
